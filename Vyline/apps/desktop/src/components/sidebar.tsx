...
function AccountSwitcher() {
  ...
  const currentName = demoMode
    ? self.name
    : currentSession?.displayName || accountId || "未ログイン";
    ...
    <div className="border-t border-[var(--vy-border)] px-3 py-2">
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-[0.65rem] text-[var(--vy-text-dim)]">
            {demoMode ? "PRデモ · 仮データ" : accountId}
          </p>
        </div>
        <IconChevron
          size={16}
